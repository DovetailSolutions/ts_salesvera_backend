...
const approveLeave = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.userData;
        const leave = yield LeaveService.approveLeave(Number(userData === null || userData === void 0 ? void 0 : userData.userId), req.body);
...
const leaveList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { page, limit, offset } = getPagination(req);
        const result = yield LeaveService.leaveList(Number(userData.userId), status, page, limit, offset);
        res.status(200).json({
            success: true,
...
const getTodayLeaveRequests = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.userData;
        const result = yield LeaveService.getTodayLeaveRequests(Number(userData.userId));
        res.status(200).json({
            success: true,
...
const cancelLeaveAndMarkPresent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.userData;
        const result = yield LeaveService.cancelLeaveAndMarkPresent(Number(userData.userId), req.body);
...
const userLeave = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userData = req.userData;
        const { page, limit, offset } = getPagination(req);
        const result = yield LeaveService.userLeave(Number(userData === null || userData === void 0 ? void 0 : userData.userId), userId, page, limit, offset);

...
exports.getHolidayById = exports.getHoliday = exports.updateHoliday = exports.addHoliday = void 0;
...
const addHoliday = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const created = yield HolidayService.createHolidays(Number(userData.userId), holidays, companyId);
        return (0, errorMessage_1.createSuccess)(res, "Holidays added successfully", created);
    }
    catch (error) {
...
const updateHoliday = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!id || isNaN(Number(id))) {
            return (0, errorMessage_1.badRequest)(res, "Valid holiday id is required");
        }
        const updated = yield HolidayService.updateHoliday(Number(id), Number(userData.userId), req.body);
        return (0, errorMessage_1.createSuccess)(res, "Holiday updated successfully", updated);
    }
    catch (error) {
        if (error instanceof serviceError_1.ServiceError)
            return (0, errorMessage_1.badRequest)(res, error.message);
...
const getHoliday = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield HolidayService.listHolidays({
        ...
        return (0, errorMessage_1.createSuccess)(res, "Holidays fetched successfully", result);
    }
    catch (error) {
        const errorMessage = error instanceof Error ? error.message : "Something went wrong";
...
const getHolidayById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const holiday = yield HolidayService.getHolidayById(Number(req.params.id), Number(userData.userId));
        return (0, errorMessage_1.createSuccess)(res, "Holiday fetched successfully", holiday);
    }
    catch (error) {
        if (error instanceof serviceError_1.ServiceError)
            return (0, errorMessage_1.badRequest)(res, error.message);

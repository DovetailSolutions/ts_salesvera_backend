...
const PreferencesService = __importStar(require("./preferences.service"));
...
const getMyPreferences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield PreferencesService.getMyPreferences(Number(userData.userId));
        (0, errorMessage_1.createSuccess)(res, "Preferences fetched successfully", result);
    }
    catch (error) {
...
const updateMyPreferences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.userData;
        const result = yield PreferencesService.updateMyPreferences(Number(userData.userId), req.body);
        (0, errorMessage_1.createSuccess)(res, "Preferences updated successfully", result);
    }
    catch (error) {
        handleServiceError(res, error);
    }

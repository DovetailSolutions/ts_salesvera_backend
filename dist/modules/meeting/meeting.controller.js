...
const scheduleMeeting = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const meeting = yield MeetingService.scheduleMeeting(Number(userData.userId), userData.role, {
...
const rescheduleMeeting = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const meeting = yield MeetingService.rescheduleMeeting(Number(userData.userId), userData.role, Number(req.params.id), scheduledTime);
...
const getMeetingDashboard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userData = req.userData;
        const dashboard = yield MeetingService.getMeetingDashboard(Number(userData.userId), userData.role);

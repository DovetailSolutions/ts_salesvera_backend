...
exports.getShiftById = exports.getShift = exports.updateShift = exports.addShift = void 0;
...
const addShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const created = yield ShiftService.addShift(Number(userData.userId), req.body);
        return (0, errorMessage_1.createSuccess)(res, "Shift(s) added successfully", created);
    }
    catch (error) {
...
const updateShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!id || isNaN(Number(id))) {
            return (0, errorMessage_1.badRequest)(res, "Valid shift id is required");
        }
        const updated = yield ShiftService.updateShift(Number(id), Number(userData.userId), req.body);
        return (0, errorMessage_1.createSuccess)(res, "Shift updated successfully", updated);
    }
    catch (error) {
        if (error instanceof serviceError_1.ServiceError)
            return (0, errorMessage_1.badRequest)(res, error.message);
...
const getShift = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield ShiftService.listShifts({
        ...
        return (0, errorMessage_1.createSuccess)(res, "Shifts fetched successfully", result);
    }
    catch (error) {
        const errorMessage = error instanceof Error ? error.message : "Something went wrong";
...
const getShiftById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const shift = yield ShiftService.getShiftById(Number(req.params.id), Number(userData.userId));
        return (0, errorMessage_1.createSuccess)(res, "Shift fetched successfully", shift);
    }
    catch (error) {
        if (error instanceof serviceError_1.ServiceError)
            return (0, errorMessage_1.badRequest)(res, error.message);

...
exports.seedPermissions = exports.PERMISSION_SEEDS = void 0;
...
const seedPermissions = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let created = 0;
    let existing = 0;
    for (const seed of exports.PERMISSION_SEEDS) {
        const [, wasCreated] = yield permission_1.Permission.findOrCreate({
    ...
    console.log(`✅ Permissions seeded: ${created} new, ${existing} already existed (total=${exports.PERMISSION_SEEDS.length})`);
});
